package com.article_db.simpleDatabase;
...
import org.h2.tools.Backup; //import org.h2.tools.DeleteDbFiles;
import org.h2.tools.Restore; //import Encryption.EncryptionHelper; //import Encryption.EncryptionUtils;
import com.article_db.Encryption.EncryptionHelper; import com.article_db.Encryption.EncryptionUtils;
/**
...
class DatabaseHelper {
	...
	static final String DB_URL = "jdbc:h2:file:C:/IntelliJ/g12CSE360-main/database/" + DB_NAME;
	//static final String DB_URL = "jdbc:h2:file:C:/IntelliJ/g12CSE360-main/database/Test1005";
	static final String DB_ROOT = "C:/IntelliJ/g12CSE360-main/database/";
	static final String DB_BACKUP_ROOT = "C:\\IntelliJ\\g12CSE360-main\\backups";
	static final String USER = "sa"; static final String PASS = "";
	private Connection connection = null;
	private Statement statement = null;
	private EncryptionHelper encryptionHelper;
	public DatabaseHelper() throws Exception { encryptionHelper = new EncryptionHelper(); }
